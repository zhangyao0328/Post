 ...
 */
public abstract class BaseTurboAdapter <T, VH extends BaseRecyclerViewHolder> extends BaseRecyclerAdapter<T, BaseRecyclerViewHolder> implements OnLoadMoreListener {
    ...
    @Override
    protected final void bindHolder(BaseRecyclerViewHolder holder, int position) {
