...
public abstract class BaseRecyclerAdapter<T, VH extends BaseRecyclerViewHolder> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    protected static final String TAG = "BaseRecyclerAdapter";
    ...
    public final BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_EMPTY_VIEW:
                vh = new BaseRecyclerViewHolder(mEmptyView);
                break;
            case TYPE_FOOTER_VIEW:
                vh = new BaseRecyclerViewHolder(mFooterView);
                break;
            case TYPE_HEADER_VIEW:
                vh = new BaseRecyclerViewHolder(mHeaderView);
                break;
            default:
    ...
    protected BaseRecyclerViewHolder onCreateLoadingViewHolder(ViewGroup parent) {
        return null;
    }

    abstract protected BaseRecyclerViewHolder onCreateDefViewHolder(ViewGroup parent, int viewType);

    private BaseRecyclerViewHolder createBaseViewHolder(ViewGroup parent, int layoutResId) {
        return new BaseRecyclerViewHolder(inflateItemView(layoutResId, parent));
    }
    ...
    private void dispatchItemClickListener(final BaseRecyclerViewHolder vh) {
